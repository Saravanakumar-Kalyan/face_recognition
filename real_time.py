...
def main(location: Path = DEFAULT_PATH):
    ...
    while True:
        ...
        face_locations, face_encodings, frame = get_face_encodings(frame)

        face_names = get_face_names(face_encodings, known_encodings)
        this = not this
        names.extend(face_names)

        draw_bounding_box(face_locations, face_names, frame)
...
def draw_bounding_box(face_locations, face_names, frame):
...
def get_face_names(face_encodings, known_encodings):
    face_names = []
...
def get_face_encodings(frame):
    ...
    return face_locations, face_encodings, frame
